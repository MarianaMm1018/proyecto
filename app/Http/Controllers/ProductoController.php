...
{
    public function index(Request $request, ProductoService $producto, CategoriaService $CategoriaService, ProveedorService $proovedorService) {
        $dataView['products'] = $producto->getProducto();
        $dataView['categorias'] = $CategoriaService->getCategorias();
